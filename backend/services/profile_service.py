    ...
    def update_my_profile(self, current_user_email: str, form_data: dict, files_data: dict):
        ...
        try:
            ...
            if profile_type == "student":
                ...
                elif 'cv_file' in files_data and not files_data['cv_file']:
                ...
                elif 'profile_picture_file' in files_data and not files_data['profile_picture_file']:
                ...
                elif 'logo_file' in files_data and not files_data['logo_file']:
